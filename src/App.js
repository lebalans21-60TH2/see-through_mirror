      ...
      <div className="App w-[100vw] h-[100vh] bg-gray-50 dark:bg-gray-800 pt-2">
        <div className='container mx-auto text-center pt-2 px-1'>

          {
            index === 0 ?
              <>
                <h1 className="text-4xl font-extrabold leading-none tracking-tight text-gray-900  dark:text-white uppercase mb-2 mt-5">Kính chiếu yêu</h1>
                {/* <a
                  target='_blank'
          ...
          <div className='mt-5'>
            <button
              ...
              onClick={handleOpenNewWindow}>{
                index === 0 ? "Bắt đầu" :
                  index === 1 ? "Đeo kính chiếu yêu" : "Tháo kính chiếu yêu"
              }
            </button>
          </div>
        </div>
